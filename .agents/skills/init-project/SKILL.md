...
4. 필요한 코드 스타일가이드가 `docs/code_styleguides/`에 있는지 확인합니다.
5. 사용할 공식 CLI 또는 스캐폴더가 있는지 확인합니다.
6. 프로젝트 구조 규칙을 `docs/tech-stack.md`와 `docs/workflow.md`에 맞게 정합니다.
7. CI 기준이 현재 기술 스택과 맞는지 `docs/ci.md`에서 확인합니다.
8. 배포 대상이 정해졌다면 `docs/deployment.md`를 확인합니다.
9. 정보가 부족하면 먼저 질문합니다.
