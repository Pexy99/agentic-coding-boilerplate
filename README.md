...
2. 루트 `README.md`를 실제 프로젝트 소개와 실행 방법으로 교체합니다.
3. `docs/product.md`에 제품 목적, 사용자, 범위, 성공 기준을 작성합니다.
4. `docs/tech-stack.md`에 사용할 기술과 제약을 작성합니다.
5. `docs/project-setup.md`를 따라 GitHub 브랜치 보호와 required check를 설정합니다.
6. 개발은 `CONTRIBUTING.md`의 스킬 흐름에 따라 진행합니다.
7. 배포 대상이 정해졌다면 `docs/deployment.md`에 배포 환경과 절차를 작성합니다.
